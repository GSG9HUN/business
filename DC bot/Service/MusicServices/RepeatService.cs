...
/// <summary>
/// Manages repeat and repeat-list functionality for guilds.
/// </summary>
public class RepeatService
{
    ...
    // Backward compatibility properties (will be deprecated)
    public Dictionary<ulong, bool> IsRepeatingDictionary => _isRepeating;
    public Dictionary<ulong, bool> IsRepeatingListDictionary => _isRepeatingList;
}
