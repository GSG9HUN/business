...
{
    public async Task HandleTrackEndedAsync(ILavalinkPlayer player, TrackEndedEventArgs args, IDiscordChannel textChannel)
    {
    ...
    private bool TryRepeatCurrentTrack(ulong guildId, out Lavalink4NET.Tracks.LavalinkTrack? track)
    {
        track = null;
    ...
    private async Task<bool> TryPlayNextFromQueueAsync(ILavalinkPlayer player, IDiscordChannel textChannel, ulong guildId)
    {
    ...
    private async Task<bool> TryRepeatListAndPlayAsync(ILavalinkPlayer player, IDiscordChannel textChannel, ulong guildId)
    {
