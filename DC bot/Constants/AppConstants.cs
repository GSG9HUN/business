...
public static class LocalizationKeys
{
    ...
    public const string CreatePlaylistCommandPlaylistLimitReached = "createPlaylist_command_playlist_limit_reached";
    ...
    public const string SavePlaylistCommandInvalidPlaylistName = "save_playlist_command_invalid_playlist_name";
    public const string SavePlaylistCommandPlaylistLimitReached = "save_playlist_command_playlist_limit_reached";
    public const string SavePlaylistCommandTrackLimitExceeded = "save_playlist_command_track_limit_exceeded";
    ...
    public const string DeletePlaylistCommandInvalidPlaylistName = "deletePlaylist_command_invalid_playlist_name";
    public const string DeletePlaylistCommandConfirmationRequired = "deletePlaylist_command_confirmation_required";
    ...
    public const string AddSongToPlaylistCommandInvalidPlaylistName = "addSong_command_invalid_playlist_name";
    public const string AddSongToPlaylistCommandTrackLimitReached = "addSong_command_track_limit_reached";
