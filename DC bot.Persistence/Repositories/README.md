...
- persist API-originated bot control commands
- provide the database bridge used by the API process and bot worker process
- keep command storage separate from direct Discord/Lavalink service calls
