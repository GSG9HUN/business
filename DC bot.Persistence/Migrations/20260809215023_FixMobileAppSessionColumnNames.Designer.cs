...
namespace DC_bot.Persistence.Migrations
{
    ...
    [Migration("20260809215023_FixMobileAppSessionColumnNames")]
    partial class FixMobileAppSessionColumnNames
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DC_bot.Entities.MobileAppSessionEntity", b =>
                {
            ...
            modelBuilder.Entity("DC_bot.Entities.MobileAppUserEntity", b =>
                {
                    b.Property<decimal>("DiscordUserId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("discord_user_id");
            ...
            modelBuilder.Entity("DC_bot.Entities.UserGuildEntity", b =>
                {
                    b.Property<decimal>("DiscordUserId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("discord_user_id");
            ...
            modelBuilder.Entity("DC_bot.Entities.MobileAppSessionEntity", b =>
                {
                    b.HasOne("DC_bot.Entities.MobileAppUserEntity", "User")
                        .WithMany()
