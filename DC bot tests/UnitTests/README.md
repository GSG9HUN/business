...
- `Commands/SlashCommands/Playlist/PlaylistSlashCommandTests.cs` covers playlist slash adapter delegation, quoted playlist-name payloads, deferred save/add-song requests, and delete confirmation.
