...
public class TagCommandTest
{
    ...
    public TagCommandTest()
    {
        ...
        var mockUserValidation = new UserValidationService(userLoggerMock.Object);
        _tagCommand = new TagCommand(mockUserValidation, logger.Object);
    }
    ...
    public async Task ExecuteAsync_User_Provided_Username()
    {
        ...
        _discordUserMock.SetupGet(du => du.IsBot).Returns(false);
        _guildMock.Setup(g => g.GetAllMembersAsync()).ReturnsAsync(new List<IDiscordMember>{discordMemberMock.Object});
        ...
        //Assert
        _messageMock.Verify(m => m.Channel.SendMessageAsync($"{discordMemberMock.Object.Mention} Wake Up!"),Times.Once);
    }
